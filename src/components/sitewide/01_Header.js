          ...
          <div className="top-menu">
            <div className="contact-info">
              <div className="content-box">
                <i className="fa-light fa-envelope-dot pe-2"></i>info@crito.com
              </div>
              <div className="content-box">
                <i className="fa-light fa-phone-volume pe-2"></i>+46 (8) 121 470
                50
              </div>
              <div className="content-box last">
                <i className="fa-regular fa-location-dot pe-2"></i>Sveavägen 31,
                111 34 STOCKHOLM
              </div>
            </div>
